  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center">
      <div className="glass-panel glass-panel-hover group relative w-full max-w-lg overflow-hidden rounded-2xl p-6 text-center sm:p-10">
        <div className="pointer-events-none absolute -right-16 -top-16 h-48 w-48 rounded-full opacity-60 blur-2xl transition-opacity duration-500 group-hover:opacity-90" style={{ background: 'radial-gradient(circle, #4C82F740, transparent 68%)' }} />
        ...
        <div className="relative mx-auto mb-4 flex h-14 w-14 items-center justify-center rounded-2xl" style={{ background: '#4C82F714', boxShadow: '0 0 24px -5px #4C82F799, inset 0 0 0 1px #4C82F733' }}>
