...
const cards = [
  { label: 'Faturamento Total', value: `R$ ${totalRevenue.toLocaleString('pt-BR')}`, sub: `${marketplaceMetrics.length} canais ativos`, icon: Wallet, primary: '#2F6BFF', secondary: '#5AB7FF' },
  ...
  { label: 'Melhor Ticket Médio', value: `R$ ${bestTicket.avgTicket.toFixed(0)}`, sub: bestTicket.marketplace, icon: Tag, primary: '#194B9B', secondary: '#2F6BFF' },
