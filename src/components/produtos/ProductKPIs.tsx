...
export default function ProductKPIs({ products }: { products: Product[] }) {
  ...
  const cards: Card[] = [
    ...
    { label: 'Ticket por Unidade', value: avgTicket, format: (v) => `R$ ${v.toLocaleString('pt-BR', { maximumFractionDigits: 0 })}`, sub: 'receita ÷ unidades vendidas', icon: Receipt, primary: '#6366F1' },
  ]
