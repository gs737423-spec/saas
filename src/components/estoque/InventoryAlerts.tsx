...
const severityConfig: Record<InventoryAlert['severity'], { icon: typeof AlertTriangle; color: string; bg: string; border: string }> = {
  danger: { icon: AlertCircle, color: '#FF5E7D', bg: 'rgba(255,95,122,0.08)', border: 'rgba(255,95,122,0.25)' },
  warning: { icon: AlertTriangle, color: '#FFC95A', bg: 'rgba(255,200,87,0.08)', border: 'rgba(255,200,87,0.25)' },
  info: { icon: Info, color: '#46E5FF', bg: 'rgba(90,183,255,0.08)', border: 'rgba(90,183,255,0.25)' },
}
