...
const statusConfig: Record<StockItem['status'], { label: string; color: string; bg: string; bar: string; rank: number }> = {
  critical: { label: 'Crítico', color: 'text-accent-rose', bg: 'bg-accent-rose/10', bar: '#FF5E7D', rank: 0 },
  stalled: { label: 'Parado', color: 'text-accent-violet', bg: 'bg-accent-violet/10', bar: '#9061F9', rank: 1 },
  low: { label: 'Baixo', color: 'text-accent-amber', bg: 'bg-accent-amber/10', bar: '#FFC95A', rank: 2 },
  ok: { label: 'Saudável', color: 'text-accent-emerald', bg: 'bg-accent-emerald/10', bar: '#3BE38E', rank: 3 },
}
