...
const cards = [
  { label: 'Itens em Estoque', value: totalStock.toLocaleString('pt-BR'), sub: `${stockItems.length} SKUs ativos`, icon: Boxes, primary: '#3A8DFF', secondary: '#46E5FF' },
  { label: 'Estoque Crítico', value: String(critical), sub: 'produtos em estado crítico', icon: AlertTriangle, primary: '#FF5E7D', secondary: '#FF5E7D' },
  { label: 'Cobertura Média', value: `${avgCoverage} dias`, sub: 'estimativa de duração', icon: Clock, primary: '#FFC95A', secondary: '#FFC95A' },
  { label: 'Produtos Parados', value: String(stalled), sub: 'sem giro relevante', icon: PauseCircle, primary: '#9061F9', secondary: '#3A8DFF' },
  { label: 'Ruptura Estimada', value: String(rupture), sub: 'ruptura em ≤ 7 dias', icon: PackageX, primary: '#FF5E7D', secondary: '#FF5E7D' },
]
