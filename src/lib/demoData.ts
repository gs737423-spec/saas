...
const DEMO_PRODUCTS: DashboardProduct[] = [
  { id: 'demo-1', sku: 'TEN-0231', name: 'Tênis Runner Pro Azul', marketplace: 'Mercado Livre', category: 'Calçados', price: 289.9, costPrice: 145, margin: 0.5, stock: 42, revenue: 24350, units: 84, trend: 0.14, sharePct: 0.19 },
  { id: 'demo-2', sku: 'MOC-1187', name: 'Mochila Urbana 20L', marketplace: 'Shopee', category: 'Acessórios', price: 159.9, costPrice: 78, margin: 0.51, stock: 118, units: 210, revenue: 33579, trend: 0.22, sharePct: 0.26 },
  { id: 'demo-3', sku: 'CAM-0552', name: 'Camiseta Dry-Fit Preta', marketplace: 'Amazon', category: 'Vestuário', price: 69.9, costPrice: 28, margin: 0.6, stock: 260, units: 340, revenue: 23766, trend: -0.05, sharePct: 0.19 },
  { id: 'demo-4', sku: 'GAR-0098', name: 'Garrafa Térmica 1L', marketplace: 'Loja Própria', category: 'Utilidades', price: 89.9, costPrice: 41, margin: 0.54, stock: 76, units: 96, revenue: 8630, trend: 0.08, sharePct: 0.07 },
  { id: 'demo-5', sku: 'RLG-0405', name: 'Relógio Smartwatch Lite', marketplace: 'Mercado Livre', category: 'Eletrônicos', price: 349.9, costPrice: 190, margin: 0.46, stock: 19, units: 58, revenue: 20294, trend: 0.31, sharePct: 0.16 },
  { id: 'demo-6', sku: 'BON-0271', name: 'Boné Trucker Bordado', marketplace: 'Shopee', category: 'Acessórios', price: 49.9, costPrice: 19, margin: 0.62, stock: 5, units: 140, revenue: 6986, trend: -0.02, sharePct: 0.06 },
]
