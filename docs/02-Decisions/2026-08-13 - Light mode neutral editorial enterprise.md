...
A TopNav light preserva largura, altura, posicao, separadores e indicador compartilhado. Sua materialidade passa para charcoal neutral com o gradiente `#1E211F` → `#242825` → `#2B302C`, highlight interno discreto e sem glow azul.
